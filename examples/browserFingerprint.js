...
<body>
  <main>
    <div class="card">
      ...
      <p>This page runs a virtualized fingerprint function generated by js-virtualizer. Serve it over HTTP for the most reliable browser behavior.</p>
...
async function main() {
    ...
    console.log("Serve the folder with a static server. Direct file:// opens may be blocked by browser security.");
}
